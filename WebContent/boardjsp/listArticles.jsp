...
%>
	...
	<a class = "cls1" href = "${contextPath}/member/logout.do"><p class = "cls2">로그아웃</p></a>
	<a class = "cls1" href = "${contextPath}/member/modMemberForm.do?id=<%=session.getAttribute("id") %>"><p class = "cls2">정보수정</p></a>
<%
	} else{
%>
	<a class = "cls1" href = "${contextPath}/memberjsp/login.jsp"><p class = "cls2">로그인</p></a>
	<a class = "cls1" href = "${contextPath}/memberjsp/memberForm.jsp"><p class = "cls2">회원가입</p></a>
<%
	}
%>
</body>
